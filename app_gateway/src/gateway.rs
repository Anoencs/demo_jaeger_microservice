use app_proto::{add::add_client::AddClient, mul::mul_client::MulClient, maths::{maths_server::Maths, AddRequest, AddResponse, MulRequest, MulResponse}, set_trace_ctx, trace_req};
